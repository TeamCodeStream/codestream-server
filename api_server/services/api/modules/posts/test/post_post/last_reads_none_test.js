...
class Last_Reads_None_Test extends CodeStream_API_Test {
	...
	validate_response (data) {
		Assert(data.user.last_reads[this.stream._id] === '0', 'last_reads for stream is not 0');
	}
}

module.exports = Last_Reads_None_Test;
