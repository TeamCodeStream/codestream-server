...
[ -z "$CS_API_PORT" ] && export CS_API_PORT=37201
...
export CS_API_SLACKBOT_ORIGIN=http://localhost.codestream.us:37202
export CS_API_TEAMSBOT_ORIGIN=http://localhost.codestream.us:37203
