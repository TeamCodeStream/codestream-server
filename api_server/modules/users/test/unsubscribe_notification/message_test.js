...
class MessageTest extends Aggregation(CodeStreamMessageTest, CommonInit) {
	...
	get description () {
		return 'user should receive a message on their me-channel updating preferences when notification email delivery is turned off by clicking an email link';
	}
	...
	// generate the message by issuing a request to unsubscribe from notification emails
	generateMessage (callback) {
		this.unsubscribeNotification(callback);
	}
