...
class MessageTest extends Aggregation(CodeStreamMessageTest, CommonInit) {
	...
	get description () {
		return 'user should receive a message on their me-channel updating preferences when reminder email delivery is turned off by clicking an email link';
	}
	...
	// generate the message by issuing a request to unsubscribe from reminder emails
	generateMessage (callback) {
		this.unsubscribeReminder(callback);
	}
