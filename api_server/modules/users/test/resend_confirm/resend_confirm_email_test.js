...
class ResendConfirmEmailTest extends CodeStreamMessageTest {
	...
	registerUser (callback) {
		...
		this.data._confirmationCheat = this.apiConfig.sharedSecrets.confirmationCheat; // to get the confirmation token back in the response
	...
	validateMessage (message) {
		...
		// FIXME: there is no 'webclient.host' property anymore. Expectation is this test is disabled
