...
class AlreadyRegisteredCompanyNameTest extends ConfirmationTest {
	...
	get description () {
		return 'should be ok to confirm a registration with an email that has already been confirmed, when the registration specified a company name';
	}
