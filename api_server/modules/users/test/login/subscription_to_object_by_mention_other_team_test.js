...
class SubscriptionToObjectByMentionOtherTeamTest extends SubscriptionToObjectByMentionTest {
	...
	get description () {
		return `user should be able to subscribe to an object channel after login when they have been mentioned in an object stream, even if they are on a different team from the creator of the object`;
	}
}
