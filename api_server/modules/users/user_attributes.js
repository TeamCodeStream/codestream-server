...
module.exports = {
	...
	firstName: {
		// deprecated in favor of full name
		type: 'string',
		maxLength: 128,
	...
	preferences: {
		...
		forMe: true,
		description:
			"Free-form object representing the user's preferences; this attribute is only visible to the user that owns it",
	},
	registeredAt: {
		type: 'timestamp',
	...
	firstSessionStartedAt: {
		...
		forMe: true,
		description:
			'Indicates first session for the user, cleared upon second login or 12 hours after first login (by client)',
	},
	inviteCode: {
		type: 'string',
		maxLength: 200,
	...
	lastInviteType: {
		...
		maxLength: 25,
		description:
			'Invite type the last time this user was invited, one of: "invitation", "reinvitation", "reviewNotification", "codemarkNotification"',
	},
	firstInviteType: {
		type: 'string',
		maxLength: 25,
		description:
			'Invite type the first time this user was invited, one of: "invitation", "reinvitation", "reviewNotification", "codemarkNotification"',
	},
	inviteTrigger: {
		type: 'string',
		maxLength: 25,
		description:
			'The ID of the object that triggered the invite, which is a "C" or "R" (for codemark or review), followed by the actual ID',
	},
	companyName: {
		type: 'string',
		serverOnly: true,
		maxLength: 100,
		description:
			'Temporary holding place for the company name, until the user actually creates a team',
	},
	externalUserId: {
		type: 'string',
		maxLength: 100,
	...
	lastReadItems: {
		type: 'object',
		description:
			'Indicates the number of replies read for each codemark or review associated with a post',
	},
	nrUserId: {
		type: 'number',
	...
	nrAzureUserId: {
		type: 'string',
		description: 'User ID of this user in New Relic Azure',
	},
};
