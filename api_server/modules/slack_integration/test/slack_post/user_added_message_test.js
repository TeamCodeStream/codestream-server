...
class UserAddedMessageTest extends SlackPostMessageTest {
	...
	get description () {
		return 'when a slack post call is made, and if the user was a known user who is not on the team that owns the stream, that user should be added to the team and the user should be in the published message';
	}
