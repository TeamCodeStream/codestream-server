...
class ExistingUserUsernameConflictTest extends UserAddedTest {
	...
	get description () {
		return 'should return an error when trying to send a slack post request from a known user who is not on the team that owns the stream and whose username conflicts with an existing user on that team';
	}
	...
	// who is creating the team for the test ... when this user posts from slack,
