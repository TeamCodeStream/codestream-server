...
class StreamNoMatchTeamTest extends SlackPostTest {
	...
	get description () {
		return 'should return an error when trying to send a slack post request with a stream ID and a team ID that are not related';
	}
