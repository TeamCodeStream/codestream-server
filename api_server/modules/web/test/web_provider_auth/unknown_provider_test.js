...
const ProviderAuthTest = require('./web_provider_auth_test');
...
class UnknownProviderTest extends ProviderAuthTest {
	...
	validateResponse (data) {
		Assert.equal(data, `/web/error?code=SWEB-1000&provider=${this.provider}`, `redirect url not correct for ${this.provider}`);
	}
}
