...
class ExistingUserInCompanyTest extends NewUserInCompanyTest {
	...
	get description () {
		let desc = 'should find the existing user and set an access token for the user when completing a New Relic authorization flow, finding a match to the user\'s New Relic ID';
