...
class UserNotFoundTest extends UnfollowTest {
	...
	get description () {
		return 'should redirect to an error page when trying to unfollow a codemark by clicking an email link, providing a valid token that refers to an unknown user';
	}
