...
class ACLStreamTest extends UnfollowTest {
	...
	get description () {
		return `should redirect to an error page when trying to unfollow a codemark via email link posted to a ${this.streamType} stream the current user is not a member of`;
	}
