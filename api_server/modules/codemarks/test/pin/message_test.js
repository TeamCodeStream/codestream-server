...
class MessageTest extends Aggregation(CodeStreamMessageTest, CommonInit) {
	...
	get description () {
		return `members of the team or stream should receive a message with the codemark when a codemark is pinned in a ${this.streamType} stream`;
	}
