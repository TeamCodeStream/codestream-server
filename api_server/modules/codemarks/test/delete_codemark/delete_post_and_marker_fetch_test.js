...
class DeletePostAndMarkerFetchTest extends DeletePostAndMarkerTest {

	get description () {
		return 'should delete associated marker when a codemark attached to a post is deleted, checked by fetching the marker';
	}
...
module.exports = DeletePostAndMarkerFetchTest;
