...
class GetCodemarksAfterLastActivityTest extends GetCodemarksByLastActivityTest {

	get description () {
		return 'should return the correct codemarks in correct order when requesting codemarks for a team and after last activity';
	}
	...
	setPath (callback) {
		super.setPath(error => {
			...
			this.path = `/codemarks?teamId=${this.team.id}&byLastActivityAt=1&after=${pivot}`;
			callback();
		});
	}
}

module.exports = GetCodemarksAfterLastActivityTest;
