...
class GetCodemarksBeforeAfterLastActivityTest extends GetCodemarksByLastActivityTest {
	...
	setPath (callback) {
		super.setPath(error => {
			...
			this.path = `/codemarks?teamId=${this.team.id}&byLastActivityAt=1&before=${beforePivot}&after=${afterPivot}`;
			callback();
		});
	}
}

module.exports = GetCodemarksBeforeAfterLastActivityTest;
