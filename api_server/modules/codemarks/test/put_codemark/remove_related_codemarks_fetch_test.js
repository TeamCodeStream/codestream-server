...
class RemoveRelatedCodemarksFetchTest extends RemoveRelatedCodemarksTest {

	get description () {
		return 'should properly update a codemark when requested, including removed related codemarks, checked by fetching the codemark';
	}
...
module.exports = RemoveRelatedCodemarksFetchTest;
