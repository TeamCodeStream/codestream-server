...
class UpdatedSetRepoMessageTest extends Aggregation(CodeStreamMessageTest, CommonInit, AddMarkersTest) {

	get description () {
		return 'members of the team should receive a message with a repo update when markers are added to a codemark and remotes are specified that were not known for the repo';
	}
