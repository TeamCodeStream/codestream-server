...
class MessageTest extends Aggregation(CodeStreamMessageTest, CommonInit) {
	...
	get description () {
		return 'members of the team should receive a message on the team channel with the codemark when markers are added to a codemark';
	}
