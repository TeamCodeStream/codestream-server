...
class FindRepoByCommitHashTest extends MarkerStreamOnTheFlyTest {
	...
	get description () {
		return 'should return a codemark directive and markers and match with the appropriate repo when adding markers to a codemark and specifying a commit hash that matches a known repo';
	}
}
