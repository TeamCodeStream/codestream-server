...
class UnrelateCodemarkTest extends Aggregation(CodeStreamAPITest, CommonInit) {

	get description () {
		return 'should return directives to update the two codemarks when removing the relation between two codemarks';
	}
...
module.exports = UnrelateCodemarkTest;
