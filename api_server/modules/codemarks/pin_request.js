// handle the PUT /pin/:id request to pin a codemark
...
class PinRequest extends RestfulRequest {
	...
	static describe () {
		return {
			...
			description: 'Pin a codemark, setting its pinned attribute to true.',
