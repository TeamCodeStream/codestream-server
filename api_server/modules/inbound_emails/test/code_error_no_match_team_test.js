...
class CodeErrorNoMatchTeamTest extends CodeErrorReplyTest {

	get description () {
		return 'should return an error when trying to send an inbound email request with a code error ID and a team ID that are not related';
	}
	...
	// code error ID ... this is not allowed!
...
module.exports = CodeErrorNoMatchTeamTest;
