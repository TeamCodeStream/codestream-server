...
class CodemarkNoMatchStreamTest extends CodemarkReplyTest {

	get description () {
		return 'should return an error when trying to send an inbound email request with a codemark ID and a stream ID that are not related';
	}
...
module.exports = CodemarkNoMatchStreamTest;
