...
class CodemarkNoMatchTeamTest extends CodemarkReplyTest {

	get description () {
		return 'should return an error when trying to send an inbound email request with a codemark ID and a team ID that are not related';
	}
	...
	// codemark ID ... this is not allowed!
...
module.exports = CodemarkNoMatchTeamTest;
