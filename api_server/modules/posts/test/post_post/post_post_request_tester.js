...
const LastReadsClearedForAuthorTest = require('./last_reads_cleared_for_author_test');
...
const NumRepliesMessageToTeamStreamTest = require('./num_replies_message_to_team_stream_test');
const NumRepliesMessageToTeamTest = require('./num_replies_message_to_team_test');
...
class PostPostRequestTester {
	...
	postPostTest () {
		...
		new LastReadsClearedForAuthorTest().test();
		...
		new NumRepliesMessageToTeamTest().test();
		new NumRepliesMessageToTeamStreamTest().test();
