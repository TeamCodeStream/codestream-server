...
class CreatorSubscriptionTest extends CodeErrorTest {
	...
	get description () {
		return 'user should be able to subscribe to the object channel for a code error after they create a code error';
	}
	...
	run (callback) {
		(async () => {
			...
			const channel = `object-${this.createPostResponse.codeError.id}`;
			try {
...
module.exports = CreatorSubscriptionTest;
