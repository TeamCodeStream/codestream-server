...
class FollowingCodeErrorFromReplyTest extends CodeErrorTest {

	get description () {
		return 'when a code error is created and another user replies, the replying user should be added as a follower';
	}
...
module.exports = FollowingCodeErrorFromReplyTest;
