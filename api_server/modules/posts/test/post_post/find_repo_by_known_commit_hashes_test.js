...
class FindRepoByKnownCommitHashesTest extends MarkerStreamOnTheFlyTest {
	...
	get description () {
		return 'should return a valid post and match with the appropriate repo when creating a post with a codemark with a marker and specifying known commit hashes that match a known repo';
	}
}
