...
class CreateRepoOnTheFlyWithCommitHashesTest extends CreateRepoOnTheFlyTest {
	...
	get description () {
		return 'should return a valid post and create a repo on the fly when creating a post with a codemark with a marker and specifying remotes that do not match an existing repo, along with known commit hashes';
	}
}
