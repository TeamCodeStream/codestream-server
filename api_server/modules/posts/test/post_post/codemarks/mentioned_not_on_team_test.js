...
class MentionedNotOnTeamTest extends FollowersMentionedTest {

	get description () {
		return 'should return an error if a user from a different team is mentioned for a codemark created with a post';
	}
...
module.exports = MentionedNotOnTeamTest;
