...
class FetchDefaultTagUpdatedTest extends UpdateDefaultTagTest {

	get description () {
		return 'should update a default tag for a team when requested, checked by fetching the team';
	}
...
module.exports = FetchDefaultTagUpdatedTest;
