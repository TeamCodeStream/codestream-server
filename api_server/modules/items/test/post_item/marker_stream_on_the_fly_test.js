...
class MarkerStreamOnTheFly extends MarkerTest {
	...
	get description () {
		return `should return the post with marker info when creating an item in a ${this.streamType} stream with a marker where the file stream will be created on the fly`;
	}
