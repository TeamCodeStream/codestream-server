...
class UpdatedSetRepoMessageTest extends Aggregation(CodeStreamMessageTest, CommonInit, MarkerTest) {
	...
	get description () {
		return 'members of the team should receive a message with a repo update when an item is posted with a marker and remotes are specified that were not known for the repo';
	}
