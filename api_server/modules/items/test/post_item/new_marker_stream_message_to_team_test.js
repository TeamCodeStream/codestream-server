...
class NewMarkerStreamMessageToTeamTest extends Aggregation(CodeStreamMessageTest, CommonInit, MarkerTest) {
	...
	get description () {
		return 'members of the team should receive a message with the stream and the item when an item is posted to a private stream with a marker from a file stream created on the fly';
	}
