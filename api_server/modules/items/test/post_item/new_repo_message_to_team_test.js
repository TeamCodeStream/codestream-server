...
class NewRepoMessageToTeamTest extends Aggregation(CodeStreamMessageTest, CommonInit, MarkerTest) {
	...
	get description () {
		return 'members of the team should receive a message with the repo when an item is posted to a private stream with a marker from a file stream created on the fly where the repo is also created on the fly';
	}
