...
class GetItemsAfterTest extends GetItemsTest {

	get description () {
		return 'should return the correct items when requesting items in a stream after a timestamp';
	}
	...
	setPath (callback) {
		...
		this.path = `/items?teamId=${this.team._id}&after=${pivot}`;
		callback();
	}
}

module.exports = GetItemsAfterTest;
