...
class PostItemRequest extends PostRequest {
	...
	static describe (module) {
		...
		description.description = 'Creates an item, currently only for usage with third-party providers (eg. slack), otherwise items must be created along with a post through POST /posts. For items referencing code blocks, provide marker objects as a sub-object of the item.';
		...
		description.input = {
			...
			looksLike: {
				...
				'markers': '<Array of @@#marker objects#marker@@ representing markers to be created for this item>'
			}
		};
		description.returns.summary = 'An item object, plus any markers created, plus streams and/or repos created for markers';
