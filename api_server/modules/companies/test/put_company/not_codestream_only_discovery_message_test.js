...
class NotCodeStreamOnlyDiscoveryMessageTest extends Aggregation(CodeStreamMessageTest, CommonInit) {
	...
	get description () {
		return `members of the team should receive a message with a company update when an attempt is made to update a company that is discovered to be no longer codestream-only`;
	}
