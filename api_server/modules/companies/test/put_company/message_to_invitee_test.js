...
class MessageToInviteeTest extends Aggregation(CodeStreamMessageTest, CommonInit) {
	...
	get description () {
		return 'users who are registered and have been invited to join a team should get a message on their user channel updating their eligibleJoinCompanies';
	}
			...
			user: {
				...
				$set: {
					eligibleJoinCompanies: [
						// this is the original company the user createdd
						{
