...
class NewUserTest extends TeamsPostTest {

	get description () {
		return 'should create and return a post when a teams post call is made, and if the user was unknown, a new user should be created, made part of the team, and returned in the response';
	}
