...
var TeamsPostMessageTest = require('./teams_post_message_test');
var RandomString = require('randomstring');
var Assert = require('assert');

class NewUserMessageTest extends TeamsPostMessageTest {

	get description () {
		return 'when a teams post call is made, and if the user was unknown, a new user should be created, and the new user should be in the published message';
	}
