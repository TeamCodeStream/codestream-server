...
class RejectTest extends Aggregation(CodeStreamAPITest, CommonInit) {
	...
	get description () {
		return 'should return directives to update a review when rejecting a review';
	}
