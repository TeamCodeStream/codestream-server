...
class UpdateSetRepoWithRemotesTest extends FindRepoByRemotesTest {
	...
	get description () {
		return 'when a marker specified a stream to be created on the fly and specifies remotes that are not known for the repo, but has new remotes as well, those new remotes should be added to the known remotes for the repo';
	}
