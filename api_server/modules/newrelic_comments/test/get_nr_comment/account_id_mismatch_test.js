...
class AccountIdMismatchTest extends GetNRCommentTest {

	get description () {
		return 'should return an error when making a request to fetch a New Relic comment but providing an account ID header that does not match the account ID of the object that owns the comment';
	}
