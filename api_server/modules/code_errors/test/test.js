...
const ResolveRequestTester = require('./resolve/test');
...
describe('code error requests', function() {
	...
	describe('PUT /code-errors/resolve/:id', ResolveRequestTester.test);
	describe('PUT /code-errors/reopen/:id', ReopenRequestTester.test);
});
