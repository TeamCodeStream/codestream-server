...
class GetCodeErrorsAfterLastActivityTest extends GetCodeErrorsByLastActivityTest {

	get description () {
		return 'should return the correct code errors in correct order when requesting code errors for a team and after last activity';
	}
	...
	setPath (callback) {
		super.setPath(error => {
			...
			this.path = `/code-errors?teamId=${this.team.id}&byLastActivityAt=1&after=${pivot}`;
			callback();
		});
	}
}

module.exports = GetCodeErrorsAfterLastActivityTest;
