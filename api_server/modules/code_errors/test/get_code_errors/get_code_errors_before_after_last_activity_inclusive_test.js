...
class GetCodeErrorsBeforeAfterLastActivityInclusiveTest extends GetCodeErrorsByLastActivityTest {
	...
	setPath (callback) {
		super.setPath(error => {
			...
			this.path = `/code-errors?teamId=${this.team.id}&byLastActivityAt=1&before=${beforePivot}&after=${afterPivot}&inclusive`;
			callback();
		});
	}
}

module.exports = GetCodeErrorsBeforeAfterLastActivityInclusiveTest;
