...
class MarkersToTeamMessageTest extends Aggregation(MessageTest, DeleteMarkersTest) {
	...
	get description () {
		...
		return `members of the team should receive a message with the deactivated markers when a code error with markers is deleted in a ${type} stream`;
	}
